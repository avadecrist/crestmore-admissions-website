          ...
          <div className='mt-6 flex justify-center'>
            <div className='flex flex-row gap-6'>
              <button
                ...
                className='flex h-12 w-full whitespace-nowrap items-center justify-center gap-2 rounded-lg bg-navy px-6 text-background transition-all duration-200 hover:bg-[#314D82]/[0.8] hover:scale-105 md:w-[158px]'
              >
                Listen Now
              <Image
